...
static _eESP01MODE mode = ESP01_MODE_STATION;

const char ATAT[] = "AT\r\n";
const char ATCIPMUX[] = "AT+CIPMUX=0\r\n";
const char ATCWQAP[] = "AT+CWQAP\r\n";
const char ATCWMODE[] = "AT+CWMODE=3\r\n";
const char ATCWMODEST[] = "AT+CWMODE=1\r\n";
const char ATCWMODEAP[] = "AT+CWMODE=2\r\n";
...
_eESP01STATUS ESP01_StartServerTCP(uint16_t serverPORT){
	if(mode == ESP01_MODE_STATION)
		return ESP01_SERVER_ERROR;

	return ESP01_SERVER_OK;
}
